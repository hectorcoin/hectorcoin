...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hectorcoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x5fd9001f, 0x5fd9001e, 0x5fd8dfe6, 0x5fd90245, 0x5fd90025, 0x6d798b41, 0x5affe09b, 0x5affe07b
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hectorcoin is probably already running."), addrBind.ToString().c_str());
        else
